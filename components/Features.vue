<template>
  <section class="features">
    ...
    <div class="feature">
      ...
      <p>
        2-factor authentication and user-controlled encryption just a couple of
        the security features we allow to help secure your files
      </p>
    </div>
    <div class="feature">
      ...
      <p>
        Security share files and folders with friends, family and colleagues
        live collaboration. No email attachments recuired
      </p>
    </div>
    <div class="feature">
      ...
      <p>
        ...
        covered allowing for all file types in the security to the securely
        stored and shared
      </p>
    </div>
  </section>
